...
export const Hero = () => {
  ...
  return (
    <div className="min-h-auto flex items-center justify-center overflow-hidden py-12 px-0 font-comic">
        ...
        <div className="text-center">
          ...
          >
            <img
              src={Game}
              alt="Game"
              className="drop-shadow-lg w-32 h-30 sm:w-44 sm:h-44 xl:w-96 xl:h-96 md:w-54 md:h-50 
               transform transition-transform duration-500 hover:scale-110 hover:-rotate-3"
            />
          </motion.div>
